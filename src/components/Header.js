    ...
    <header className={style.Header}> 
      <div className={style.topo}>
        ...
        <div className={style.divButtons}>
            <button className={style.button} onClick={() => window.location.href='/login'} >Entrar / Cadastro
              <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className={style.icon} style={{color: 'rgb(48, 58, 66)', width: '19px', height: '19px', marginLeft: '7px'}} height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"></path><polyline points="10 17 15 12 10 7"></polyline><line x1="15" y1="12" x2="3" y2="12"></line></svg>
            </button>
        
          <button className={`${style.buttonCelular} ${style.button}`}>Compre pelo celular
